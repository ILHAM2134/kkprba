          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <p className="mb-8 inline-block text-xl font-semibold">
                  Kontak Kami
                </p>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <a
                    href="https://www.instagram.com/rorobellaayu/"
                    target="_blank"
                    rel="noreferrer"
                    className="block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                ...
                <p className="mt-1 flex items-center gap-2">
                  <FaTwitter className="block" />

                  <a
                    href="https://twitter.com/rr_bella"
                    target="_blank"
                    rel="noreferrer"
                    className="block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
