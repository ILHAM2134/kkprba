...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-[#ffffffcf] pb-16 pt-[120px] dark:bg-[#000000b0] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
        <div
          className="absolute top-0 -z-30 h-full w-full bg-[#ffffffcf] bg-cover dark:bg-[#000000b0]"
          style={{
            backgroundImage: `url(${bgHero.src})`,
          }}
        />

        <div className="absolute top-0 -z-20 h-full w-full bg-[#ffffffcf] bg-cover dark:bg-[#000000b0]" />
